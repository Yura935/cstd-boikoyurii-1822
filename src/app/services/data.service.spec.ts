...
describe('DataService', () => {
  ...
  it('should set currentContact', () => {
    const spy = spyOn(service, 'setCurrentContact');
    const mock = {
    ...
    service.setCurrentContact(mock);
    expect(service.currentContact).toBeTruthy();
    expect(spy).toHaveBeenCalledWith(mock);
  });

  it('should set adding', () => {
    const spy = spyOn(service, 'setAdding');
    service.setAdding(true);
  ...
  it('should return current user', () => {
    const data = service.getOne('yurko');
